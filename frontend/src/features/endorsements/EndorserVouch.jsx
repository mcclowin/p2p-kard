...
import { AlertCircle, Handshake, Check, Shield } from "lucide-react";
import {
        ...
        <div className="max-w-xl mx-auto space-y-6">
          <FadeIn>
            <div className="text-center py-8 space-y-4">
              <div className="inline-flex w-16 h-16 rounded-full bg-emerald-100 items-center justify-center"><Handshake className="w-8 h-8 text-emerald-600" /></div>
    ...
    return (
      <Page>
        <div className="max-w-xl mx-auto text-center py-12 space-y-6">
          <FadeIn>
            <div className="inline-flex w-20 h-20 rounded-full bg-emerald-100 items-center justify-center"><Check className="w-10 h-10 text-emerald-600" /></div>
        ...
        <FadeIn delay={0.05}>
          <Card title="Loan Request Summary">
            ...
            <div className="mt-3 rounded-xl bg-emerald-50/60 border border-emerald-200/40 p-3 text-xs text-[var(--color-text-muted)]">
              <span className="inline-flex items-center gap-1.5"><Shield className="w-3.5 h-3.5" /> The borrower's identity is protected.</span> Only the loan details are shared.
            </div>
          </Card>
        </FadeIn>
