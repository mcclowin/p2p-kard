...
const variants = {
  primary:
    "text-white bg-emerald-700 hover:bg-emerald-800 shadow-[0_4px_20px_rgba(0,168,92,0.35)] hover:shadow-[0_6px_28px_rgba(0,168,92,0.5)]",
  secondary:
  ...
  warm:
    "text-white bg-gradient-to-r from-emerald-700 to-emerald-600 hover:from-emerald-800 hover:to-emerald-700 shadow-[0_4px_20px_rgba(0,168,92,0.35)]",
};
