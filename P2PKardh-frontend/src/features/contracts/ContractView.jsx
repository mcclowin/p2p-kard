...
function StatusBanner({ status }) {
  const config = {
    GENERATED: { bg: "bg-amber-50 border-amber-200/60", text: "text-amber-800", icon: "📝", label: "Awaiting borrower signature" },
    BORROWER_SIGNED: { bg: "bg-blue-50 border-blue-200/60", text: "text-blue-800", icon: "✍️", label: "Signed by borrower" },
    ACTIVE: { bg: "bg-emerald-50 border-emerald-200/60", text: "text-emerald-800", icon: "✅", label: "Active" },
    COMPLETED: { bg: "bg-[var(--color-surface-warm)] border-[var(--color-border)]", text: "text-[var(--color-text-muted)]", icon: "🎉", label: "Completed" },
    FORGIVEN: { bg: "bg-purple-50 border-purple-200/60", text: "text-purple-800", icon: "💜", label: "Forgiven (converted to Sadaqah)" },
  };
